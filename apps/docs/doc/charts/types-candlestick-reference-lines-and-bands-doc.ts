...
@Component({
    selector: 'types-candlestick-reference-lines-and-bands-doc',
    standalone: true,
    imports: [AppDocSectionText, AppCode, ChartsModule],
    template: `
        <app-docsectiontext>
            <p>
                Add <i>ChartReferenceLine</i> to mark price levels such as support, resistance, and moving averages. Add <i>ChartReferenceBand</i> to highlight consolidation zones and trading ranges. Set <i>y</i> for horizontal price levels,
                <i>x</i> for vertical time markers.
            </p>
...
export class CandlestickReferenceLinesAndBandsDoc {
    readonly data = [
