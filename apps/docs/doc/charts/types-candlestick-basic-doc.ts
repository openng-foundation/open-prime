...
@Component({
    selector: 'types-candlestick-basic-doc',
    standalone: true,
    imports: [AppDocSectionText, AppCode, ChartsModule],
    template: `
        <app-docsectiontext>
            <p>Map data fields with <i>categoryXField</i>, <i>openField</i>, <i>highField</i>, <i>lowField</i>, and <i>closeField</i>. Positive candles rise (close &gt; open), negative candles fall (close &lt; open).</p>
        </app-docsectiontext>
        @defer (on viewport) {
            <div class="card">
...
export class CandlestickBasicDoc {
    readonly data = [
