...
@Component({
    selector: 'types-candlestick-axes-doc',
    standalone: true,
    imports: [AppDocSectionText, AppCode, ChartsModule],
    template: `
        <app-docsectiontext>
            <p>
                Set <i>type="time"</i> on <i>ChartXAxis</i> for continuous date and timestamp data. Tick labels format based on the visible range from minutes up to years. Use <i>type="logarithmic"</i> on <i>ChartYAxis</i> for long-term price data
            ...
            <div class="card">
                <div style="height: 460px">
                    <p-chart-svg>
                        ...
                        <p-chart-x-axis label="Date" />
                        <p-chart-y-axis label="Price ($)" [tickCount]="8" />
                    </p-chart-svg>
                </div>
            </div>
            <app-code></app-code>
...
export class CandlestickAxesDoc {
    readonly data = [
