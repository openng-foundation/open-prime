...
@Component({
    selector: 'types-candlestick-candle-styling-doc',
    standalone: true,
    imports: [AppDocSectionText, AppCode, ChartsModule],
    template: `
        <app-docsectiontext>
            <p>
                Set <i>barWidthRatio</i> to control how much of the available category space each candle body fills. <i>0.7</i> uses 70% of the space, leaving gaps between candles. Set <i>wickStrokeWidth</i> to adjust the wick line thickness in
                pixels.
            </p>
        </app-docsectiontext>
        @defer (on viewport) {
...
export class CandlestickCandleStylingDoc {
    readonly data = [
