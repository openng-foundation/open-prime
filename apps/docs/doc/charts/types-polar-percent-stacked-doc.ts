...
@Component({
    selector: 'types-polar-percent-stacked-doc',
    standalone: true,
    imports: [AppDocSectionText, AppCode, ChartsModule],
    template: `
        <app-docsectiontext>
            <p>Set <i>mode="percent"</i> on <i>ChartStacked</i> to normalize each sector to 100%. Shows the relative proportion of each series rather than absolute values, useful for comparing composition across categories.</p>
        </app-docsectiontext>
        @defer (on viewport) {
            <div class="card">
...
export class PolarPercentStackedDoc {
    readonly data = [
